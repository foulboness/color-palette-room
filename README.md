...
PALETTE ROOM is an interactive color exploration studio for generating, editing, testing, and saving color palettes. Designed with a dark creative-lab aesthetic, it combines color experimentation with practical design tools.
...
```text
GENERATE · LOCK · EDIT · SAVE · EXPORT
```

Additional interactions include keyboard shortcuts, drag-and-drop colors, hover effects, smooth animations, responsive layouts, and accessibility-focused controls.
